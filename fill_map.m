function [point,boundary,b_gate,ip_out,ip_in,i_bd_out,ib_in,ib_out,i_bd_trans_in,i_bd_trans_out]=fill_map(p_cross,size_in,size_out,l_roads,gate_switch)
...
for i = 1 : size(p_cross,1)
    ...
    boundary = [boundary; (i-1)*4+1,(i-1)*4+2; (i-1)*4+2,(i-1)*4+3; (i-1)*4+3,(i-1)*4+4; (i-1)*4+4,(i-1)*4+1];
